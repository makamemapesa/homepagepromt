...
# Security check: Only raise error if DEBUG explicitly set to False via env var
if os.environ.get("DEBUG") == "False" and SECRET_KEY == "django-insecure-change-me-in-production":
    raise ImproperlyConfigured(
        "You must set a secure SECRET_KEY environment variable before running in production (DEBUG=False)."
    )
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "public_application": "10/hour",  # 10 online application submissions per hour per IP
    },
}
